...
This shows that, even on the subset of loci that HipSTR does genotype, it's accuracy is approximately the same as GangSTR's but worse than ExpansionHunter's. 
